      ...
      <div className="container xl:max-w-[1250px] xxl:max-w-[1700px] 2xl:max-w-[1600px]">
        ...
        <div className="text-center mb-16 xxl:mb-18 space-y-6">
          <AnimatedHeading
            ...
            className="text-3xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-5xl xxl:text-6xl font-[1200] leading-[1.15] tracking-tight max-w-4xl xxl:max-w-6xl mx-auto font-bold"
          />

          <p className="text-base md:text-base lg:text-base xxl:text-lg text-dark max-w-4xl xxl:max-w-5xl mx-auto leading-relaxed">
              ...
              >
                ...
                <div
                  className={`
                    ...
                    rounded-2xl xl:rounded-2xl xxl:rounded-3xl 
                    flex items-center justify-center 
                    shrink-0
                    shadow-inner
                  `}
                >
                  <Icon className="w-7 h-7 lg:w-8 lg:h-8 xxl:w-10 xxl:h-10" />
                </div>

                {/* Text Content */}
                <div>
                  <h3 className="text-xl lg:text-2xl xxl:text-3xl font-extrabold text-black">
                    {feature.title}
                  </h3>
                  <p className="text-dark text-sm lg:text-base xxl:text-lg font-medium">
                    {feature.subtitle}
                  </p>
                </div>
              </div>
