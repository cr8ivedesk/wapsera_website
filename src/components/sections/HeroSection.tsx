        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 xxl:gap-24 items-center">
          ...
          <div className="space-y-8 xxl:space-y-10">
            ...
            <AnimatedHeading
              ...
              className="text-3xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl xxl:text-[5rem] leading-[1.1] tracking-tighter text-foreground font-extrabold"
            />
